...
const NAV: NavItem[] = [
  ...
  { to: "/follow-up", label: "Action Center", icon: ReminderIcon, chip: "bg-fuchsia-50 text-fuchsia-700" },
  { to: "/record-integrity", label: "Record Check", icon: IntegrityIcon, chip: "bg-orange-50 text-orange-700" },
