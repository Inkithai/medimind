export const en = {
  ...
  nav: {
    ...
    descriptions: {
      ...
      whoToSee: "See whether a pharmacist or a doctor should look at your records.",
  ...
  settings: {
    ...
    workspaceNameBody:
      "Give this workspace a name you recognise (for example “Amma's records”). Names are shared across MediMind, so each one must be unique.",
    workspaceNamePlaceholder: "e.g. Amma's records",
    workspaceNameCurrent: "Current name",
    workspaceNameNone: "This workspace has no name yet.",
    nameChecking: "Checking…",
    nameAvailable: "Available",
    nameTaken: "Already taken — try another name",
    nameInvalid: "Use 1–40 letters, numbers, spaces, or . _ ' -",
    nameIsCurrent: "This is your current name",
    saveName: "Save name",
    nameSaving: "Saving…",
    nameSaved: "Workspace name saved",
    nameSaveFailed: "Could not save the workspace name",
    healthPassport: "Health passport",
    healthPassportBody:
      "A one-page printable PDF for a new doctor: your active medications, allergies, key conditions, and recent abnormal labs. The pocket version of Appointment Prep.",
    healthPassportNote:
      "Nothing here is a diagnosis. Bring it to a clinician to confirm each item, and carry medication packaging where possible.",
    downloadPassport: "Download PDF",
    passportDownloading: "Preparing your PDF…",
    passportDownloaded: "Health passport downloaded",
    passportFailed: "Could not create the health passport",
    passportNoRecords: "Upload documents first — there is no record to summarise yet.",
  ...
  about: {
    ...
    e20: "Deterministic routing of every finding to a pharmacist or doctor, with urgency and specialty.",
    e21: "Reconciled medicine list per ingredient: active, duplicate, dose conflict or discontinued.",
    e22: "Early-warning trajectory across every dated reading, with trend and worsening signals.",
    e23: "Lifecycle state of each safety finding (open, reviewed, dismissed, resolved, reopened).",
    e24: "Full record export: native JSON copy or FHIR R4 Bundle for another health system.",
    e25: "Structural validation of the generated FHIR Bundle before it is shared with a clinic.",
    e26: "Append-only audit history of every field correction made in this workspace.",
