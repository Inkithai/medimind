export const en = {
  ...
  about: {
    ...
    p5Body: "A workspace is tied to your browser — no account needed. You can start fresh or reset your data at any time.",
    ...
    f5Body: "Ask questions in plain language. MediMind retrieves the most relevant passages from your records and answers only from those, with citations you can open.",
    f6Title: "Find Care",
    ...
    pl1: "Optional account linking so a workspace can be recovered on another device.",
    pl2: "Server-side session persistence for conversations.",
    pl3: "Per-document sharing controls.",
