...
_TYPE_SYNONYMS: Dict[str, tuple] = {
    "prescription": (
        "prescription", "prescriptions", "rx", "script", "medication chart",
        "medication list", "drug chart", "drug list", "repeat prescription",
    ),
    "lab_report": (
        "lab", "laboratory", "lab report", "lab result", "lab results",
        "laboratory report", "laboratory result", "laboratory results",
        "blood test", "blood report", "pathology", "biochemistry", "culture",
    ),
    "discharge_summary": (
        "discharge", "discharge summary", "discharge note", "discharge report",
        "discharge letter", "transfer summary",
    ),
    "consultation_note": (
        "consultation", "consult note", "consultation note", "clinic note",
        "doctor note", "doctor's note", "doctor visit", "opd", "outpatient",
        "clinic visit", "follow up note", "follow-up note", "progress note",
    ),
    "imaging_report": (
        "imaging", "xray", "x-ray", "x ray", "mri", "ct scan", "ct report",
        "ultrasound", "ultra sound", "mammogram", "radiology", "radiograph",
        "scan report", "scan result",
    ),
    "procedure_report": (
        "procedure", "surgical", "surgery", "operative", "endoscopy",
        "colonoscopy", "biopsy",
    ),
}
