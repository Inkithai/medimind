...
def test_projection_builds_independent_stable_entity_rows():
    ...
    assert (
        first["clinical_prescriptions"][0]["data"]["medication_id"]
        == first["clinical_medications"][0]["id"]
    )
...
def test_age_restriction_evaluator_is_conservative_and_cited():
    rows = [
        {
            "wanted": "medicine-a",
            "restriction": "not for use in children under 12 years",
            "source_page": 44,
            "population": "children",
        },
            ...
            "eml_age_conflicts": [
                {
                    ...
                    "restriction": "under 12 years",
                    "explanation": "Published age restriction.",
                    "confidence": 0.95,
                    "source_page": 44,
                    "population": "children",
                }
