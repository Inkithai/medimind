...
from clinical_lab_values import collect_lab_values, latest_lab_value
from vital_trends import _series_for, _VITALS  # reuse the vital parsers
...
def compute_early_warning_score(timeline: Dict[str, Any]) -> Dict[str, Any]:
    ...
    add("potassium", k_val,
        _points_for(k_val, [(0, 3.0, 3), (3.0, 3.5, 2), (3.5, 5.5, 0), (5.5, 6.0, 1), (6.0, 100, 3)]),
        3, "mmol/L")
    ...
    if total >= 7:
        ...
        band, advice = "medium", "Some recent readings are abnormal. Arrange a clinical review soon."
    elif total >= 1:
    ...
    return {
        ...
        "note": ("This is an automated screening score from your most recent readings (NEWS2-style "
